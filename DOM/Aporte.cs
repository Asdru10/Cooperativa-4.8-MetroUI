...
namespace DOM
{
    public class Aporte
    {
        ...
        public Aporte(int id, int cedula_Asociado, int id_Estado_Financiero_Mensual, int periodo_Estado_Financiero_Mensual, String detalle, decimal monto, DateTime fecha, String tipo)
        {
            ID = id;
